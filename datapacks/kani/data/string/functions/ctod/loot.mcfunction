...
summon minecraft:armor_stand 0.5 -64.0 0.5 {Tags:["sk_string_ctod"],Invulnerable:1b,Marker:1b,NoGravity:1b}
...
execute as @e[type=minecraft:armor_stand,tag=sk_string_ctod,limit=1] run loot replace entity @s weapon.offhand loot string:ctod
